<div id="projects" class="flex flex-col items-center w-full justify-between tablet:justify-evenly mb-10">

    <h1 class="text-5xl tablet:text-4xl phone:text-3xl my-4 text-slate-800 font-medium font-sans w-2/3 laptop:w-4/5 tablet:w-11/12 phone:w-11/12 text-left">
       <b class="font-medium"> Our Best</b>  <span class="text-amber-400">Projects .</span> 
    </h1>
    ...
    <div id="projects_cards" class="w-2/3 laptop:w-4/5 tablet:w-11/12 phone:w-11/12 tablet:h-4/5 h-5/6 flex flex-row phone:flex-col ">
        ...
        <div id="right_card" class="w-1/3 flex phone:w-full flex-col items-center justify-between h-full">
