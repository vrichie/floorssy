    ...
    <div id="pricing_wrapper" class="laptop:w-4/5 tablet:w-11/12 w-2/3 h-5/6 flex items-center phone:flex-col-reverse  phone:w-11/12">
        <div id="pricing_cards" class="w-1/2 h-2/3 grid phone:w-11/12  grid-cols-2 gap-2 ">
            <div class=" flex flex-col items-center justify-between  w-5/6 h-5/6 ">
                ...
                <h6 class="font-thin tablet:text-xs phone:text-xs text-amber-400">
                    <i class="line-through text-slate-700">ksh3500.0</i>
                    ksh3000
                </h6>
            </div>
            ...
            <div class=" flex flex-col items-center justify-between  w-5/6 h-5/6 ">
                ...
                <h2 class="text-xl tablet:text-sm phone:text-sm font-light text-slate-800">
                    ...
                    <h6 class="font-thin tablet:text-xs phone:text-xs text-amber-400">
                        <i class="line-through text-slate-700">ksh7500.0</i>
                        ksh6000
                    </h6>
            </div>
            ...
            <div class=" flex flex-col items-center justify-between  w-5/6 h-5/6 ">
                ...
                <h2 class="text-xl tablet:text-sm phone:text-sm font-light text-slate-800">
                    ...
                    <h6 class="font-thin tablet:text-xs phone:text-xs text-amber-400">
                        <i class="line-through text-slate-700">ksh8500.0</i>
                        ksh8000
                    </h6>
            </div>
            ...
            <div class=" flex flex-col items-center justify-between  w-5/6 h-5/6 ">
                ...
                <h2 class="text-xl tablet:text-sm phone:text-sm font-light text-slate-800">
                    ...
                    <h6 class="font-thin tablet:text-xs phone:text-xs text-amber-400">
                        <i class="line-through text-slate-700">ksh6000.0</i>
                        ksh5000
                    </h6>
            </div>

        </div>
        <div id="pricing_trending_product" class="w-1/2 h-full flex flex-col justify-evenly phone:w-full">
            <h1 class="text-5xl tablet:text-4xl phone:text-3xl phone:my-5 text-slate-800 font-semibold font-sans ">
            ...
            <a href="#footer">
                <button class="bg-amber-400 my-5 py-3 px-4 border-2 tablet:text-sm phone:py-2 phone:px-2 phone:text-sm border-amber-400 w-fit text-slate-200">
                    Contact us
                </button>
            </a>
        </div>
